...
- Karma levels gate the review workflow: L0 submissions need two approvals before publishing, L1 needs one approval from a trusted reviewer, all submissions are pending review until approved (self-review always blocked); L2+ may review others, L3 administers. Self-review is always blocked.
